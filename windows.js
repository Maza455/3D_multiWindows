...
// this code is essential to circumvent that some browsers preload the content of some pages before you actually hit the url
    ...
    function setupScene() {
        ...
        renderer = new t.WebGLRenderer({ antialis: true, depthRuffer: true });
        renderer.setPixelRadio(pixR);
    ...
    function render() {
        ...
        // loop through all our shapes and update their position based on current window positions
